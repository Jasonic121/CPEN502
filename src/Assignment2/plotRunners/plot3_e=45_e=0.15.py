...
# File paths
file_paths = [
    '/Users/jason/Courses/UBC/CPEN502/CPEN502/out/production/CPEN502/Assignment2/RLRobot/JBot.data/JBot_a=0.1_policy=false_e=0.45_intermediate=true.log',
    '/Users/jason/Courses/UBC/CPEN502/CPEN502/out/production/CPEN502/Assignment2/RLRobot/JBot.data/JBot_a=0.1_policy=false_e=0.15_intermediate=true.log'
]
...
# Add legend
plt.legend(labels=['e=0.45','e=0.15'])
...
plt.savefig(os.path.join(save_dir, 'plot3_e=0.45_e=0.15.png'))

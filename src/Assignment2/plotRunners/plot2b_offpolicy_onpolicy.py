...
# File paths
file_paths = [
    '/Users/jason/Courses/UBC/CPEN502/CPEN502/out/production/CPEN502/Assignment2/RLRobot/JBot.data/JBot_a=0.1_policy=true_e=0.0_intermediate=true.log',
...
# Add legend
plt.legend(labels=['On-policy','Off-policy'])
...
plt.savefig(os.path.join(save_dir, 'plot2b_offpolicy_onpolicy.png'))

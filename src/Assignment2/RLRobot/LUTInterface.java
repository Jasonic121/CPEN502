...
//    * into an ordinal that can then be used to access the associated look up table element. * @param X The state action vector used to index the LUT
//    * @return The index where this vector maps to
//    */
//   public int indexFor(double [] X); } // End of public interface LUT

...
# File paths
file_paths = [
    '/Users/jason/Courses/UBC/CPEN502/CPEN502/out/production/CPEN502/Assignment2/RLRobot/JBot.data/JBot_a=0.0_policy=false_e=0.0_intermediate=true.log',
...
# Add legend
plt.legend(labels=['alpha = 0','alpha = 0.1'])
...
plt.savefig(os.path.join(save_dir, 'plot2a_alpha=0_alpha=0.1.png'))
